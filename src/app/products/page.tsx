  ...
  return (
    <>
      ...
      <Container className="py-12 md:py-16">
        <div className="mb-8 grid gap-4 rounded-[26px] bg-white/76 p-6 ring-1 ring-[#DDE7E7]/65 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
          ...
          <div className="flex flex-wrap gap-2">
            {["전체", "생활지원", "안전보호", "건강관리", "후원 가능"].map((item) => (
              <span key={item} className="inline-flex min-h-10 items-center gap-2 rounded-full bg-[#F8FAFB] px-4 text-sm font-black text-[#334155] ring-1 ring-[#DDE7E7]/65">
        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          <aside className="rounded-[24px] bg-[#F8FAFB] p-5 ring-1 ring-[#DDE7E7]/65">
