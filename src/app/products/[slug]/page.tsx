  ...
  return (
    <Container className="py-12 md:py-16">
      <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          <div className="relative min-h-[520px] overflow-hidden rounded-lg border border-[#DDE7E7] bg-[#E5E7EB] shadow-lg">
            <Image
              ...
              priority
            />
            <div className="absolute left-5 top-5 rounded-md bg-white/92 px-4 py-2 text-sm font-black text-[#155F70] shadow-sm">
              {product.categories?.name ?? "제품"}
            </div>
          </div>
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            {["상담 접수", "구성 확인", "납품/전달"].map((step) => (
              <div key={step} className="rounded-lg border border-[#DDE7E7] bg-white p-4 text-center shadow-sm">
        ...
        <div>
          ...
          <div className="mt-7 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-[#DDE7E7] bg-white p-5 shadow-sm">
          ...
          <div className="prose-clean mt-8 rounded-lg border border-[#DDE7E7] bg-white p-6 text-lg leading-8 text-[#475569] shadow-sm">
